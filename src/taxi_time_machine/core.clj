...
; ; KAFKA
;
(def producer-conf (producer/producer {"metadata.broker.list" "localhost:9092"
...
(defn create-topic
  ...
  (kf-admin/create-topic zk "butt")))

(defn send-to-kafka
  [msg]
  (producer/send-message producer-conf (producer/message "butt" (.getBytes (json/encode msg)))))
;
